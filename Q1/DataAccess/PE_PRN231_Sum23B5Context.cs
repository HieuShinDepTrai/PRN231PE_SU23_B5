...
{
    public partial class PE_PRN231_Sum23B5Context : DbContext
    {
        public PE_PRN231_Sum23B5Context()
        {
        }

        public PE_PRN231_Sum23B5Context(DbContextOptions<PE_PRN231_Sum23B5Context> options)
            : base(options)
        {
        }
